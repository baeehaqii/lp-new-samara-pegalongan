    ...
    const testimonials: Testimonial[] = [
        {
            ...
            rating: 5,
            text: "Lokasi strategis dekat kota Purwokerto dan berada di jalur alternatif ke Banyumas maupun Cilacap.",
        },
        {
            id: 2,
            name: "M. Afif",
            location: "Purwokerto, Indonesia",
            image: "https://res.cloudinary.com/dx8w9qwl6/image/upload/v1764488270/gambar-8_t2p9jt.avif",
            rating: 5,
            text: "Samara pegalongan udara nya sejuk, nyaman, harganya murah, lokasinya strategis cocok untuk keluarga kecil.",
        },
