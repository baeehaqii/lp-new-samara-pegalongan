          ...
          <div className="modal-container" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-content">
              ...
              <div className="modal-description">
                <p>
                  Berada di Jl. Raya Gunung Tugel, Pegalongan, Patikraja, Samara Pegalongan adalah perumahan Purwokerto yang menempatkan kamu di kawasan Segitiga Emas Purwokerto, dekat dengan segala kebutuhan sehari-hari. Hunian ini dirancang fungsional dengan lingkungan tertata, legalitas aman, dan akses gampang ke sekolah, pusat belanja, layanan kesehatan, serta pusat aktivitas kota. Setiap unit nyaman untuk rumah pertama kamu, memberi ruang bagi momen keluarga yang hangat dan kehidupan sehari-hari yang lebih praktis.
                </p>
                ...
                <ul className="modal-list">
                  ...
                  <li>Dikelilingi area hijau dan pemandangan perbukitan</li>
                </ul>
