...
export const metadata: Metadata = {
  ...
  keywords: [
    "Samara Pegalongan",
    "Perumahan Pegalongan",
    "Rumah Pegalongan",
    "Hunian Modern Pegalongan",
    "Properti Pegalongan",
    "Rumah Murah Pegalongan",
  ...
  return (
    <html lang="id">
      <head>
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-WTWJBZF8');`,
          }}
        />
      ...
      <body style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif' }}>
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-WTWJBZF8"
            height="0"
            width="0"
